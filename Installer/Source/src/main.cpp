...
private:
    ...
    void StartLibraryThumbLoader() {
        ...
        // Two lightweight decode workers are enough to keep the viewport fed without
        // turning scrolling into a CPU-heavy preload of the entire library.
        libraryThumbLoadThreads_.emplace_back(worker);
        libraryThumbLoadThreads_.emplace_back(worker);
    }
